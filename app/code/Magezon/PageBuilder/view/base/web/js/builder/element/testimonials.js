	...
	var directive = function(magezonBuilderUrl) {
		return {
			...
			templateUrl: function(elem) {
				return magezonBuilderUrl.getTemplateUrl(elem, 'Magezon_PageBuilder/js/templates/builder/element/testimonials.html');
			},
			controller: function($scope, $controller) {
				...
				var initTestimonials = function() {
		            ...
		            $scope.additionalClass += ' mgz-testimonials-' + _element.testimonial_type;
