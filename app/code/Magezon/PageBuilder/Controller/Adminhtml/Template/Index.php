...
class Index extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Magezon_PageBuilder::template';
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Page Builder'), __('Page Builder'));
        $resultPage->addBreadcrumb(__('Manage Templates'), __('Manage Templates'));
        $resultPage->getConfig()->getTitle()->prepend(__('Magezon Page Builder Templates'));
        return $resultPage;
    }
}
