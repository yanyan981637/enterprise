define(["jquery"], function ($) {
  return {
    controller: function (
      ...
      magezonBuilderService.post(
        "mgzbuilder/widget/index",
        {},
        false,
        function (res) {
            ...
            function (res) {
              $scope.$apply(function () {
                ...
                $scope.model[$scope.options.key] =
                  magezonBuilderFilter.decodeContent(res);
              });
            }
          );
        }
      ...
      $(document).on(
        "click",
        ".rule-param-apply,.rule-param-remove,.data-grid ._clickable,#select_widget_type,.x-tree-node-el",
        function () {
          $scope.updateValue();
        }
      );
      ...
      $(document).on(
        "change",
        "#widget_options_form *[name^='parameters'],#select_widget_type",
        function () {
