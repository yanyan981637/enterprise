...
class Tag implements ItemProviderInterface
{
    ...
    {
        $items = [];
        if ($this->dataHelper->getConfig('sitemap/tag/enabled')) {
            ...
            $items = array_map(function ($item) use ($storeId) {
                return $this->itemFactory->create([
                    ...
                    'priority' => $this->dataHelper->getConfig('sitemap/tag/priority'),
                    'changeFrequency' => $this->dataHelper->getConfig('sitemap/tag/changefreq'),
                ]);
            }, $collection->getItems());
        }
