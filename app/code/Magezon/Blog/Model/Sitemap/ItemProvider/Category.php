...
class Category implements ItemProviderInterface
{
    ...
    {
        $items = [];
        if ($this->dataHelper->getConfig('sitemap/category/enabled')) {
            ...
            $items = array_map(function ($item) use ($storeId) {
                return $this->itemFactory->create([
                    ...
                    'priority' => $this->dataHelper->getConfig('sitemap/category/priority'),
                    'changeFrequency' => $this->dataHelper->getConfig('sitemap/category/changefreq'),
                ]);
            }, $collection->getItems());
        }
