...
use Mirasvit\LayeredNavigation\Model\Layer\Filter\RatingFilter;
...
class FilterList extends Template
{
    ...
    public function getFilterItemLabel(Item $filterItem): string
    {
        $label = (string)$filterItem->getData('label');

        if ($filterItem->getFilter() instanceof RatingFilter) {
            return (string)__('%1 & Up', $label);
        }
