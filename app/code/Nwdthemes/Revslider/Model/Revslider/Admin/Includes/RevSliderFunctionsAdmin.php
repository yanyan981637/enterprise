...
class RevSliderFunctionsAdmin extends RevSliderFunctions {
	...
	public function get_javascript_multilanguage(){
		$lang = array(
			...
			'previewnotworking' => __('The preview could not be loaded due to some error', 'revslider'),
			...
			'embedingLine2' => __('For the <b>CMS Pages and Blocks</b> insert the Shortcode:', 'revslider'),
			'embedingLine2a' => __('Or Use the <b>Insert Widget</b> button and choose the <b>Slider Revolution Widget</b> and select the slider.', 'revslider'),
			'embedingLine3' => __('You can add the new <b>Slider Revolution Widget Instance</b> and configure it to be displayed on the specific part of the page.', 'revslider'),
			'embedingLine4' => __('Advanced Module Embedding', 'revslider'),
			'embedingLine5' => __('For the <b>XML Layout Update</b> use the following code:', 'revslider'),
			'embedingLine6' => __('To add the slider inside of the <b>template file</b> use this one:', 'revslider'),
