...
/*!
 * jQuery2 JavaScript Library v1.11.3
 * http://jquery.com/
 *
 * Includes Sizzle.js
 * http://sizzlejs.com/
...
(function( global, factory ) {
    ...
    if ( typeof module === "object" && typeof module.exports === "object" ) {
        ...
        // execute the factory and get jQuery2
        // For environments that do not inherently posses a window with a document
        // (such as Node.js), expose a jQuery2-making factory as module.exports
        // This accentuates the need for the creation of a real window
        // e.g. var jQuery2 = require("jquery")(window);
    ...
    jQuery2.extend({
        ...
        globalEval: function( data ) {
            if ( data && jQuery2.trim( data ) ) {
                ...
                // rather than jQuery2 in Firefox
...
// Implement the identical functionality for filter and not
    function winnow( elements, qualifier, not ) {
        ...
        return jQuery2.grep( elements, function( elem ) {
            return ( jQuery2.inArray( elem, qualifier ) >= 0 ) !== not;
        });
    }
                ...
                if ( match && (match[1] || !context) ) {
                    ...
                    if ( match[1] ) {
                        ...
                        if ( elem && elem.parentNode ) {
                            ...
                            // Otherwise, we inject the element directly into the jQuery2 object
                            this.length = 1;
                            this[0] = elem;
                        }
...
// Initialize central reference
    ...
    jQuery2.extend({
        dir: function( elem, dir, until ) {
            ...
            while ( cur && cur.nodeType !== 9 && (until === undefined || cur.nodeType !== 1 || !jQuery2( cur ).is( until )) ) {
                if ( cur.nodeType === 1 ) {
                    matched.push( cur );
                }
                cur = cur[dir];
    ...
    jQuery2.each({
        ...
        contents: function( elem ) {
            return jQuery2.nodeName( elem, "iframe" ) ?
                elem.contentDocument || elem.contentWindow.document :
                jQuery2.merge( [], elem.childNodes );
        }
    }, function( name, fn ) {
...
// The deferred used on DOM ready
    ...
    jQuery2.extend({
        ...
        ready: function( wait ) {
            ...
            if ( !document.body ) {
                return setTimeout( jQuery2.ready );
            }
...
// Execute ASAP in case we need to set body.style.zoom
     ...
     */
    jQuery2.acceptData = function( elem ) {
        var noData = jQuery2.noData[ (elem.nodeName + " ").toLowerCase() ],
...
// checks a cache object for emptiness
    ...
    function internalData( elem, name, data, pvt /* Internal Use Only */ ) {
        ...
        var ret, thisCache,
            internalKey = jQuery2.expando,

            // We have to handle DOM nodes and JS objects differently because IE6-7
            // can't GC object references properly across the DOM-JS boundary
            isNode = elem.nodeType,

            // Only DOM nodes need the global jQuery2 cache; JS object data is
            // attached directly to the object so GC can occur automatically
            cache = isNode ? jQuery2.cache : elem,
        ...
        if ( !cache[ id ] ) {
            // Avoid exposing jQuery2 metadata on plain JS objects when the object
            // is serialized using JSON.stringify
            cache[ id ] = isNode ? {} : { toJSON: jQuery2.noop };
        }

        // An object can be passed to jQuery2.data instead of a key/value pair; this gets
        ...
        // jQuery2 data() is stored in a separate object inside the object's internal data
    ...
    function internalRemoveData( elem, name, pvt ) {
        ...
        var thisCache, i,
            ...
            // See jQuery2.data for more information
            cache = isNode ? jQuery2.cache : elem,
            id = isNode ? elem[ jQuery2.expando ] : jQuery2.expando;
    ...
    jQuery2.fn.extend({
        data: function( key, value ) {
            ...
            // Special expections of .data basically thwart jQuery2.access,
            ...
            return arguments.length > 1 ?
                ...
                elem ? dataAttr( elem, key, jQuery2.data( elem, key ) ) : undefined;
        },
    ...
    jQuery2.fn.extend({
        ...
        promise: function( type, obj ) {
            ...
            while ( i-- ) {
                tmp = jQuery2._data( elements[ i ], type + "queueHooks" );
                if ( tmp && tmp.empty ) {
                    count++;
...
// The value/s can optionally be executed if it's a function
    ...
    jQuery2.event = {
        ...
        add: function( elem, types, handler, data, selector ) {
            ...
            if ( !(eventHandle = elemData.handle) ) {
                eventHandle = elemData.handle = function( e ) {
                    ...
                    return typeof jQuery2 !== strundefined && (!e || jQuery2.event.triggered !== e.type) ?
                        jQuery2.event.dispatch.apply( eventHandle.elem, arguments ) :
                        undefined;
                };
        ...
        remove: function( elem, types, handler, selector, mappedTypes ) {
            var j, handleObj, tmp,
                ...
                namespaces, origType,
                elemData = jQuery2.hasData( elem ) && jQuery2._data( elem );
        ...
        dispatch: function( event ) {
            ...
            var i, ret, handleObj, matched, j,
                ...
                handlers = ( jQuery2._data( this, "events" ) || {} )[ event.type ] || [],
    ...
    jQuery2.removeEvent = document.removeEventListener ?
        ...
        jQuery2.event.special.submit = {
            setup: function() {
                ...
                jQuery2.event.add( this, "click._submit keypress._submit", function( e ) {
                    ...
                    var elem = e.target,
                        form = jQuery2.nodeName( elem, "input" ) || jQuery2.nodeName( elem, "button" ) ? elem.form : undefined;
                    if ( form && !jQuery2._data( form, "submitBubbles" ) ) {
                        jQuery2.event.add( form, "submit._submit", function( event ) {
                            event._submit_bubble = true;
                        });
                        jQuery2._data( form, "submitBubbles", true );
                    }
                });
            ...
            postDispatch: function( event ) {
                ...
                if ( event._submit_bubble ) {
                    ...
                    if ( this.parentNode && !event.isTrigger ) {
                        jQuery2.event.simulate( "submit", this.parentNode, event, true );
                    }
                }
            },
        ...
        jQuery2.event.special.change = {
            ...
            setup: function() {
                ...
                if ( rformElems.test( this.nodeName ) ) {
                    ...
                    if ( this.type === "checkbox" || this.type === "radio" ) {
                        ...
                        jQuery2.event.add( this, "click._change", function( event ) {
                            ...
                            jQuery2.event.simulate( "change", this, event, true );
                        });
                    }
                    return false;
                }
                ...
                jQuery2.event.add( this, "beforeactivate._change", function( e ) {
                    ...
                    if ( rformElems.test( elem.nodeName ) && !jQuery2._data( elem, "changeBubbles" ) ) {
                        jQuery2.event.add( elem, "change._change", function( event ) {
                            if ( this.parentNode && !event.isSimulated && !event.isTrigger ) {
                                jQuery2.event.simulate( "change", this.parentNode, event, true );
                            }
                        });
                        jQuery2._data( elem, "changeBubbles", true );
                    }
                });
            },
...
// Create "bubbling" focus and blur events
            ...
            jQuery2.event.special[ fix ] = {
                setup: function() {
                    var doc = this.ownerDocument || this,
                        attaches = jQuery2._data( doc, fix );
                ...
                teardown: function() {
                    var doc = this.ownerDocument || this,
                        attaches = jQuery2._data( doc, fix ) - 1;
    ...
    var nodeNames = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|" +
        ...
        rinlinejQuery2 = / jQuery2\d+="(?:null|\d+)"/g,
...
// Mark scripts as having already been evaluated
    function setGlobalEval( elems, refElements ) {
        ...
        for ( ; (elem = elems[i]) != null; i++ ) {
            jQuery2._data( elem, "globalEval", !refElements || jQuery2._data( refElements[i], "globalEval" ) );
        }
    }
    ...
    function cloneCopyEvent( src, dest ) {
        ...
        var type, i, l,
            oldData = jQuery2._data( src ),
            curData = jQuery2._data( dest, oldData ),
    ...
    jQuery2.extend({
        clone: function( elem, dataAndEvents, deepDataAndEvents ) {
            ...
            if ( (!support.noCloneEvent || !support.noCloneChecked) &&
                (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery2.isXMLDoc(elem) ) {
        ...
        cleanData: function( elems, /* internal */ acceptData ) {
            ...
            for ( ; (elem = elems[i]) != null; i++ ) {
                if ( acceptData || jQuery2.acceptData( elem ) ) {
                    ...
                    if ( data ) {
                        ...
                        // Remove cache only if it was not already removed by jQuery2.event.remove
                        if ( cache[ id ] ) {
    ...
    jQuery2.fn.extend({
        ...
        html: function( value ) {
            return access( this, function( value ) {
                ...
                if ( value === undefined ) {
                    return elem.nodeType === 1 ?
                        elem.innerHTML.replace( rinlinejQuery2, "" ) :
                        undefined;
                }
                    ...
                    if ( hasScripts ) {
                        ...
                        for ( i = 0; i < hasScripts; i++ ) {
                            ...
                            if ( rscriptType.test( node.type || "" ) &&
                                !jQuery2._data( node, "globalEval" ) && jQuery2.contains( doc, node ) ) {
    ...
    jQuery2.each({
        ...
        jQuery2.fn[ name ] = function( selector ) {
            ...
            for ( ; i <= last; i++ ) {
                ...
                // Modern browsers can apply jQuery2 collections as arrays, but oldIE needs a .get()
...
// return a css property mapped to a potentially vendor prefixed property
    ...
    function getWidthOrHeight( elem, name, extra ) {
        ...
        var valueIsBorderBox = true,
            ...
            isBorderBox = support.boxSizing && jQuery2.css( elem, "boxSizing", false, styles ) === "border-box";
        ...
        jQuery2.cssHooks.opacity = {
            ...
            set: function( elem, value ) {
                var style = elem.style,
                    ...
                    opacity = jQuery2.isNumeric( value ) ? "alpha(opacity=" + value * 100 + ")" : "",
                ...
                if ( ( value >= 1 || value === "" ) &&
                    jQuery2.trim( filter.replace( ralpha, "" ) ) === "" &&
    ...
    function defaultPrefilter( elem, props, opts ) {
        ...
        if ( elem.nodeType === 1 && ( "height" in props || "width" in props ) ) {
            ...
            checkDisplay = display === "none" ?
                jQuery2._data( elem, "olddisplay" ) || defaultDisplay( elem.nodeName ) : display;
                ...
                while ( (name = attrNames[i++]) ) {
                    ...
                    if ( jQuery2.expr.match.bool.test( name ) ) {
                        ...
                        if ( getSetInput && getSetAttribute || !ruseDefault.test( name ) ) {
                            ...
                            elem[ jQuery2.camelCase( "default-" + name ) ] =
                                elem[ propName ] = false;
                        }
...
// Retrieve booleans specially
    jQuery2.each( jQuery2.expr.match.bool.source.match( /\w+/g ), function( i, name ) {
        ...
        attrHandle[ name ] = getSetInput && getSetAttribute || !ruseDefault.test( name ) ?
            ...
            function( elem, name, isXML ) {
                if ( !isXML ) {
                    return elem[ jQuery2.camelCase( "default-" + name ) ] ?
                        name.toLowerCase() :
                        null;
                }
            };
...
// IE6/7 do not support getting/setting some attributes with get/setAttribute
    if ( !getSetAttribute ) {
        ...
        jQuery2.each([ "width", "height" ], function( i, name ) {
...
// http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx
    if ( !support.hrefNormalized ) {
        ...
        jQuery2.each([ "href", "src" ], function( i, name ) {
            ...
            return this.each(function() {
                if ( type === "string" ) {
                    ...
                    if ( this.className ) {
                        ...
                        jQuery2._data( this, "__className__", this.className );
                    }
                    ...
                    this.className = this.className || value === false ? "" : jQuery2._data( this, "__className__" ) || "";
                }
            });
        },
...
// Return jQuery2 for attributes-only inclusion
    ...
    jQuery2.parseJSON = function( data ) {
        ...
        return str && !jQuery2.trim( str.replace( rvalidtokens, function( token, comma, open, close ) {
            ...
            ( Function( "return " + str ) )() :
            jQuery2.error( "Invalid JSON: " + data );
    };
...
// Fixes #9887
    ...
    jQuery2.expr.filters.hidden = function( elem ) {
        ...
        return elem.offsetWidth <= 0 && elem.offsetHeight <= 0 ||
            ...
            ((elem.style && elem.style.display) || jQuery2.css( elem, "display" )) === "none");
    };
...
// (This is still attached to ajaxSettings for backward compatibility)
    jQuery2.ajaxSettings.xhr = window.ActiveXObject !== undefined ?
        // Support: IE6+
        function() {
            ...
            if ( !options.crossDomain || support.cors ) {
                ...
                return {
                    send: function( headers, complete ) {
                        ...
                        // handled in jQuery2.ajax (so no try/catch here)
...
// Bind script tag hack transport
    jQuery2.ajaxTransport( "script", function(s) {
        ...
        if ( s.crossDomain ) {
            ...
            var script,
                head = document.head || jQuery2("head")[0] || document.documentElement;
    ...
    jQuery2.offset = {
        setOffset: function( elem, options, i ) {
            ...
            calculatePosition = ( position === "absolute" || position === "fixed" ) &&
                jQuery2.inArray("auto", [ curCSSTop, curCSSLeft ] ) > -1;
    ...
    jQuery2.each( { scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function( method, prop ) {
        ...
        jQuery2.fn[ method ] = function( val ) {
            return access( this, function( elem, method, val ) {
                ...
                if ( win ) {
                    win.scrollTo(
                        !top ? val : jQuery2( win ).scrollLeft(),
                        top ? val : jQuery2( win ).scrollTop()
                    );
...
// Expose jQuery2 and $ identifiers, even in
