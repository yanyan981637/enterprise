<?php
namespace Mitac\Homepage\Controller\Adminhtml\Banner;
...
class Edit extends Action
{
    ...
    public function execute()
    {
        ...
        if ($id) 
        {
            ...
            {
                $this->messageManager->addErrorMessage(__('This Banner block no longer exists.'));
        ...
        $this->_view->getPage()->getConfig()->getTitle()->prepend(
            $model->getId() ? __("Edit Banner Block '%1'", $model->getId()) : __('New Banner Block')
        );
