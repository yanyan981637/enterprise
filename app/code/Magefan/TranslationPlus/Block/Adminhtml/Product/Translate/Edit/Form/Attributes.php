...
namespace Magefan\TranslationPlus\Block\Adminhtml\Product\Translate\Edit\Form;
        ...
        if ($group) {
            ...
            if (!$form->getElement(
                ...
                $attributeSearch = $this->getLayout()->createBlock(
                    \Magefan\TranslationPlus\Block\Adminhtml\Product\Translate\Edit\Form\Attributes\Search::class
                )->setGroupId(
                    $group->getId()
                )->setProduct(
                    $product
